...
try {
    ...
    & $mkcert -install
    & $mkcert "*.xmcloudpreview_dev.localhost"
...
Add-HostsEntry "www.xmcloudpreview_dev.localhost"
...
if ($InitEnv) {
    ...
    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.xmcloudpreview_dev.localhost"
